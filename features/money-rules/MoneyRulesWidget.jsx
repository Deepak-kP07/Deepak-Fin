...
export function MoneyRulesWidget({ rules, onOpen }) {
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-violet-500/10 via-transparent to-accent-500/5 p-5">
      <div className="mb-3 flex items-center justify-between">
        ...
        <button onClick={onOpen} className="text-xs text-accent-300 hover:underline">Manage</button>
      </div>
      {active.length === 0 ? (
