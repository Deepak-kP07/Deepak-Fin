    ...
    <div className="space-y-5">
      ...
      {money_rules.length === 0 ? (
        ...
        <div className="space-y-2">
          {money_rules.map((r, i) => (
            <div key={r.id} className="group flex items-center gap-3 rounded-2xl border border-white/10 light:border-black/10 bg-white/[.035] light:bg-black/[.025] px-4 py-3">
