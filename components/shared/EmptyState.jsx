export function EmptyState({ icon: Icon, title, message, cta, onCta, compact = false }) {
  if (compact) {
    return (
      <div className="p-5 text-center">
        <div className="mx-auto flex h-9 w-9 items-center justify-center rounded-xl bg-accent-300/10 text-accent-200"><Icon size={16} /></div>
  ...
  return (
    <div className="p-14 text-center">
      <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-accent-300/10 text-accent-200"><Icon size={20} /></div>
