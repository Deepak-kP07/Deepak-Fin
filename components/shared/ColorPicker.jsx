...
export function ColorPicker({ value, onChange }) {
  ...
  return (
    <div className="mt-2 flex flex-wrap items-center gap-2">
      ...
      <label
        className={`relative flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-full border-2 text-[10px] font-semibold text-white/80 ${!isPreset ? 'border-white' : 'border-white/20 light:border-black/15'}`}
