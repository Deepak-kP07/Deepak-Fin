...
export function StatCard({ label, value, sub, icon: Icon, accent = 'bg-accent-300/10 text-accent-200 light:text-accent-700', tone = 'text-emerald-300 light:text-emerald-700', onClick }) {
  ...
  return (
    <Tag
      ...
      className={`min-w-0 rounded-2xl border border-white/10 light:border-black/10 bg-[#0e121c] light:bg-black/[.025] p-3.5 glassy:glass-card${onClick ? ' w-full text-left transition hover:bg-white/[.06] hover:light:bg-black/[.04]' : ''}`}
    >
