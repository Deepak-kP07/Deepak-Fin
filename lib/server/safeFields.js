export const safeFields = {
  ...
  lend_borrow: ['person_name', 'type', 'amount', 'date', 'due_date', 'from_account_id', 'reason', 'notes'],
  ...
  chit_funds: ['name', 'duration_months', 'monthly_contribution', 'start_date', 'account_id', 'notes'],
