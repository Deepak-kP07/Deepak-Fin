export const safeFields = {
  ...
  profiles: ['full_name', 'age', 'avatar_url', 'theme', 'accent_color', 'currency', 'kite_access_token', 'kite_access_token_at', 'block_insufficient_funds', 'module_settings', 'dashboard_widgets', 'mobile_nav_settings', 'weekly_report_enabled', 'monthly_report_enabled', 'tour_completed_at'],
