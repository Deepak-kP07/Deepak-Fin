export const safeFields = {
  accounts: ['name', 'type', 'bank_name', 'account_number_last4', 'opening_balance', 'currency', 'color', 'icon', 'is_active', 'linked_account_id', 'order_index'],
  ...
  profiles: ['full_name', 'age', 'avatar_url', 'theme', 'accent_color', 'currency', 'kite_access_token', 'kite_access_token_at', 'block_insufficient_funds', 'module_settings', 'dashboard_widgets', 'weekly_report_enabled', 'monthly_report_enabled'],
  ...
  money_profile_entries: ['profile_id', 'entry_type', 'category_id', 'description', 'amount', 'date', 'paid_party', 'notes'],
