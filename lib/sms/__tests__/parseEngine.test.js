...
describe('parseSms', () => {
  ...
  it('never treats an OTP request as a completed transaction, even one naming a real merchant/card/amount', () => {
    ...
    const result = parseSms(SMS_PATTERN_SEEDS, { sender: 'SBICARD', body: '075906 is the OTP for Trxn. of INR 596.00 at Flipkart with your credit card ending 1037. OTP is valid for 10 mins. Do not share it with anyone - SBI Card' })
