...
export const notificationEvents = pgTable('notification_events', {
  ...
  check('notification_events_type_check', sql`${t.type} in ('card_due','loan_due','recurring_generated','budget_overspend','recurring_money_profile_generated','pending_review_digest','app_update','chit_fund_due')`),
